...
def main() -> None:
    ...
    ap.add_argument("--config", default="configs/base_v28_civilcomments_objfam_10seeds.yaml")
    ap.add_argument("--dataset", default="civilcomments")
    ap.add_argument("--suite_suffix", default="civilcomments_objfam_10s_20260328")
    ap.add_argument("--python", default=sys.executable)
    ap.add_argument("--skip_embed", type=int, default=1)
    ...
    regimes = [
        "erm",
        "erm_softclip_p95_a10_cc",
        "erm_labelsmooth_e10_cc",
        "erm_focal_g2_cc",
    ]
    ...
    _run(
        [
            ...
            tag_filter,
            "--out_rows",
            str(repo_root / "artifacts" / "metrics" / f"civilcomments_selected_calibration_{suite_suffix}_rows.csv"),
            "--out_summary",
            str(repo_root / "artifacts" / "metrics" / f"civilcomments_selected_calibration_{suite_suffix}_summary.csv"),
        ],
        cwd=repo_root,
    )
    ...
    manifest_path = repo_root / "artifacts" / "metrics" / f"civilcomments_objfam_manifest_{suite_suffix}.json"

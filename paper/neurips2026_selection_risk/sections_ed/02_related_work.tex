...
Our recommendation is complementary to checkpoint averaging, stronger stopping rules, and label-free selector diagnostics: we do not claim validation-loss selection dominates those methods, but that proxy-selected reports should expose whether their conclusions survive validation-loss and held-out reliability checks.
